#  Pomodoro Timer
 ...
 -  **Easy Controls**: Start, pause, and reset your timer with one click
 ...
 - Plain HTML
 - Simple CSS styling
 - Vanilla JavaScript (no extra tools needed!)
 ---
 ##  Run It Locally
 1. Download these files:
    ...
    - `style.css`
    - `script.js`
 2. Double-click `index.html` — it opens in your browser, ready to use!
